...
clustering = KubernetesPodOperator(
    ...
    image="us.icr.io/sifi_ds/audience_expansion:latest",
    cmds=["/bin/sh", "-c"],
    arguments=["python3 -u /audience_development/keyword_recommendation/kwd_cluster.py"],
    image_pull_policy='Always',
    labels={"environment": "production", "track": "daily"},
    ports=[PORT],
    name="clustering",
...
recommendation = KubernetesPodOperator(
    ...
    image="us.icr.io/sifi_ds/audience_expansion:latest",
    cmds=["/bin/sh", "-c"],
    arguments=["python3 -u /audience_development/keyword_recommendation/kwd_recommend.py"],
    image_pull_policy='Always',
    labels={"environment": "production", "track": "daily"},
    ports=[PORT],
    name="recommendation",
